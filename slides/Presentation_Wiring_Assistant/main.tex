...
%	TODO LIST
%----------------------------------------------------------------------------------------
% - Alle Vorkommen von "cable" durch "wire" ersetzen
% - Will ich eine Final Slide?
...
\maketitlepage
\setcounter{framenumber}{0} % Exclude title page from framenumber count
...
\begin{frame}{Worst Case (Time/Space)}
    ...
    %     \graphicoffset
        ...
        \begin{tikzpicture}[scale=0.16]
            ...
            \pgfdeclarelayer{metallayer}
            \pgfsetlayers{main,metallayer}
            % \circbwire<1->[color_circb_wire](3,5,35,5)
            % \circbwire<1->[color_circb_wire](5,3,5,37)
            % \circbwire<1->[color_circb_wire](1,35,37,35)
            % \circbwire<1->[color_circb_wire](33,1,33,39)
            % \circbwire<1->[color_circb_wire](9,11,29,11)
            % \circbwire<1->[color_circb_wire](7,29,31,29)
            % \circbwire<1->[color_circb_wire](11,9,11,31)
            % \circbwire<1->[color_circb_wire](27,7,27,33)
            % \circbwire<1->[color_circb_wire](15,17,23,17)
            % \circbwire<1->[color_circb_wire](13,23,25,23)
            % \circbwire<1->[color_circb_wire](17,15,17,25)
            % \circbwire<1->[color_circb_wire](21,13,21,27)
            % the points to connect
